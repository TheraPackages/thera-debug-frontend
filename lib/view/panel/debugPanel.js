    ...
    return (
      React.createElement("div", null, 
        ...
        React.createElement(Collapse, {defaultActiveKey: ['callStack', 'scope', 'breakpoint']}, 
          React.createElement(Panel, {header: "Call Stack", className: "debug-section-header call-stack", key: "callStack"}, 
            React.createElement(CallStack, {callstack: this.props.model.callStackModel, provider: this.props.provider})
          ), 
          React.createElement(Panel, {header: "Scope", className: "debug-section-header scope", key: "scope"}, 
            React.createElement(Scope, {scopeModel: this.props.model.scopeModel, provider: this.props.provider})
          ), 
          React.createElement(Panel, {header: "Break Points", className: "debug-section-header breakpoints", key: "breakpoint"}, 
