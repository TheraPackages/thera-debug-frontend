  ...
  render () {
    return (
      React.createElement("div", null, 
        React.createElement(Collapse, {defaultActiveKey: ['debugControl', 'callStack', 'scope', 'breakpoint']}, 
          React.createElement(Panel, {header: "Debug Control", className: "debug-section-header", key: "debugControl"}, 
          ...
          React.createElement(Panel, {header: "Scope", className: "debug-section-header", key: "scope"}, 
            React.createElement(Scope, {scope: this.props.model.scopeModel})
          ), 
